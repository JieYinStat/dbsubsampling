## code to prepare `data_IES_Case_1_Train` dataset goes here
m1 <- function(x) {
  8 / (4 + x)
}
...
data_IES_Case_1_Train <- gene_data(N, rho, lower, upper, sd, distribute = "normal")
usethis::use_data(data_IES_Case_1_Train, overwrite = TRUE)
