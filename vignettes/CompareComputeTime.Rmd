...
- `IBOSS`: Quoted from [Yu et.al.(2022)](https://www.tandfonline.com/doi/suppl/10.1080/01621459.2020.1773832?scroll=top) (core code adapted from [Wang et.al.(2019)](https://github.com/Ossifragus/IBOSS)) which use Rcpp but core code is C++ style (mainly circulates against scalars).
...
time_IBOSS <- data.frame(Size, time_IBOSS, time_myR_IBOSS, time_myRcpp_IBOSS, time_myArma_IBOSS)
